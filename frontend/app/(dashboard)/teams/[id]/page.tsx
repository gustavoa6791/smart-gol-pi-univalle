      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <Card className="col-span-1 shadow-xl border-2 border-green-200 bg-white overflow-hidden pt-0 gap-0">
          ...
          <CardContent className="flex flex-col items-center gap-3 pt-6">
            <div className="w-48 h-48 rounded-xl overflow-hidden bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center border-2 border-green-200 shadow-md">
              {team.shield_url ? (
                <img
